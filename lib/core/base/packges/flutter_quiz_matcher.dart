...
import 'package:shater/core/base/packges/extension/extension.dart';
import 'package:shater/core/base/packges/painter/painter.dart';
                ...
                for (int j = 0; j < answersOffset.length; j++) {
                  if (answersOffset[j].contains(p2)) {
                    if (listLine[j].ansSelection == false) {
                      ...
                      listLine[i].panEndOffset =
                          Offset(answersOffset[j].left, answersOffset[j].top + answersOffset[j].height / 2);
                      listLine[i].panStartOffset = Offset(questionsOffset[i].right,
                          questionsOffset[i].bottom - questionsOffset[i].height / 2);
