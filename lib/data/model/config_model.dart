...
class ConfigModel implements Decodable<ConfigModel> {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['language'] = langs.map((v) => v.toJson()).toList();
...
class BaseUrls {
  ...
  String? parcelTypeImageUrl;
  String? thumbnailItem;
  String? complainantImage;
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    parcelTypeImageUrl = json['parcel_type_image_url'];
    thumbnailItem = json['thumbnail_item'];
    complainantImage = json['complainant_image_url'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['parcel_type_image_url'] = parcelTypeImageUrl;
    data['complainant_image_url'] = complainantImage;
    return data;
  }
}
