...
import 'package:shater/network%202/exceptions/app_exception.dart';
import 'package:shater/network%202/exceptions/network_exception.dart';
import 'package:shater/network%202/exceptions/not_found_exception.dart';
import 'package:shater/network%202/exceptions/service_unavailable_exception.dart';
...
Exception handleDioError(DioException dioError) {
  switch (dioError.type) {
    ...
    case DioExceptionType.badCertificate:
      return AppException(message: "Bad Certificate with API server");
